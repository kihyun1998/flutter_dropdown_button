      ...
      child: Column(
        ...
        children: [
          ...
          FlutterMultiSelectDropdown<String>(
            ...
            // (the shell's `_applyWidthConstraints`), so it fills the *main*
            // axis of the `Flex` it is in — inside this `Column` that is the
            // vertical one, and the button was drawn 402 pixels tall with its
            // label floating in the middle. Reach for `expand` in a `Row`, or
            // wrap the dropdown in one.
            //
